...
const DashboardProfile = () => {
  ...
  return (
    ...
    >
      ...
      <CounterContainer>
        <ProfileCounter fontWeight={600} padding={'4px'} count={1} text="Friends" />
        <ProfileCounter fontWeight={600} padding={'4px'} count={0} text="My Life" />
        <ProfileCounter fontWeight={600} padding={'4px'} count={3} text="Events" last={true} />
      </CounterContainer>
      <ProfileInvestments />
      <ProfileGoals />
      <CounterContainer>
