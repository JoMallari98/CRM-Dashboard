...
import { Box, CardContent, CardActions, Grid, Avatar, Divider } from '@mui/material'
...
const UpcomingEventCard: React.FC = () => {
            ...
            <div onClick={() => setOpenModal(true)} style={{ cursor: "pointer" }}>
                <Grid container>
                    <Grid item lg={3} xl={3} xs={3} sm={3} md={3}>
                        <Avatar alt="Remy Sharp" src={img as any} variant="rounded" />
                    </Grid>
                    <Grid item lg={9} xl={9} xs={9} sm={9} md={9}>
                        <Grid container>
                            ...
                            <Grid item>
                                <Grid container>
                                    <span style={{ fontSize: '10px', marginRight: '2px', color: "rgba(0, 0, 0, 0.5)" }}>{dateRange}</span>
                                    {
                                        joined && <JoinedBadge>
                                            Joined
                                        </JoinedBadge>
    ...
    return (
        <Box sx={{
            background: '#ffff', boxShadow: "4px 4px 32px rgba(10, 81, 143, 0.17)",
