          ...
          <Box display="flex" flexDirection="column">
            ...
            <Container maxWidth="sm">
              ...
              <Typography mb={2}>
                ...
                Notices to your email address indicated below, and you
                acknowledge your responsibility to timely notify us of any
                change in your email address for notice purposes. You also
                understand that this consent is effective until revoked and that
                you may revoke your consent for electronic delivery at any time
                by providing us written notice.
              </Typography>
              <Typography mb={2}>
              ...
              <Typography mb={2}>
                Should you decline electronic delivery, we will decline to open
                an account for you, and will close any account that may have
                been opened by you previously.
              </Typography>
            </Container>
