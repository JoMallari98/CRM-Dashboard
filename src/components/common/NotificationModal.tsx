...
import { Popover, Grid, Box, CardContent, styled, Avatar, Divider } from '@mui/material'
...
const NotificationData: NotificationItemProps[] = [
    {
        ...
        title: 'Kate Simons liked your portfolio!',
        content: 'Kate Simons liked your portfolio “Environment”.',
        date: '3 min ago'
    },
    {
        img: "/static/images/avatar/1.jpg",
...
const NotificationModal: React.FC<NotificationModalProps> = ({ open = false, setOpen, id }) => {
    ...
    const NotificationItem: React.FC<NotificationItemProps> = ({ img, title, content, date }) => {
        return (
            <Grid container spacing={3}>
                ...
                <Grid item style={{ color: "rgba(0, 0, 0, 0.5)", fontSize: '12px' }} lg={3} xl={3} md={3} xs={3} sm={3}>
                    {date}
                </Grid>
            </Grid >
        )
    ...
    return (
        ...
        >
            <Box sx={{ width: '512px', background: '#ffff', boxShadow: '4px 4px 32px rgba(10, 81, 143, 0.17)', borderRadius: '16px' }}>
                <CardContent>
