...
import { Dialog, Box, useMediaQuery, useTheme, Typography, FormControl, Button, styled, Avatar} from '@mui/material';
...
const Popup = (props: any) => {
    ...
    return (
    <Dialog data-testid="popup-component" open={props.popUp} onClose={() => props.setPopUp(false)} style={{zIndex: "10001", backdropFilter: "blur(4px)"}} sx={{ '& .css-mkuhab-MuiPaper-root-MuiDialog-paper' : {backgroundColor: "transparent !important", borderRadius: "16px !important", overflowX: "hidden"},}}>
        <Box width={smDown ? "100%" : "589px"} height="377px" borderRadius="1(6px" style={{backgroundColor: "#fff", padding: "20px"}}>
        ...
        <Formik
            ...
            initialValues={ {
              mobileNumber: !props.resendCode ? " " : typeof window !== 'undefined' ? localStorage.getItem("mobile-number") || '' : '',
          ...
          >
            ...
            >
              <Box mt={2}>
                <Box width={400}>
                  <FormControl fullWidth sx={smDown ? {width: "70%", my: 2, ml: "15%"} : { my: 2 }} >
                    <CustomTextField
              ...
              >
                {props.buttonText}
                {loader && <Avatar data-testid="loader" src="/loader.gif" style={{width:"20px", height:"20px", marginLeft:"10px"}}  alt="loader" />}
              </ContinueButton>
            </Box>
          </Formik>
        </Box>
